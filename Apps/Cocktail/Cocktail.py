#!/usr/bin/env python3
""" @brief  Emergence of noise level and of discussion group at a 'cocktail party':
...
class LandCell(Landscape_.LandCell):
	...
	def __init__(self):
		Landscape_.LandCell.__init__(self, (0, 0), VoidCell=(0, 0))
...
class Landscape(Landscape_.Landscape):
	...
	def __init__(self, Size):
		Landscape_.Landscape.__init__(self, Width=Size, CellType=LandCell)	# calls local LandCell definition
...
class Individual:
	...
	def locate(self, NewPosition):
		...
		self.display() # for ongoing display
		return True
