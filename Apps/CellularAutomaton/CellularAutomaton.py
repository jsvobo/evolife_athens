...
class Automaton:
	...
	def display(self):
		for C in self.Ground:
			...
			Observer.record((f'{C}_{self.VPosition}', (C.Position, (-self.VPosition) % Depth, Scenario.Colours[C.content()], -1/256, 'shape=rectangle')))
...
if __name__ == "__main__":
	...
	EW.Start(CAutomaton.OneStep, Observer, Capabilities='RP', Options={'Run':True})		# R means that only changed positions have to be displayed; P enables photos
