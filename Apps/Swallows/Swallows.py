#!/usr/bin/env python3
""" @brief  Studying Collective Decision:
...
class Swallow_Observer(EO.Experiment_Observer):
	...
	def __init__(self, Params):
		super().__init__(Params) # stores global information
	...
	def Field_grid(self):
		"""	initial display 
		"""
		return [('Wire',(1, WirePosition-3, 'black', 3, self['NbAgents'], WirePosition-3, 'grey', 3),)]
...
class Swallow:
	...
	def display(self):
		Observer.record((self.Name,(self.IdNb, self.Position, 'black', 30, 'shape=swallow.gif')))
...
class Population:
	...
	def Many_decisions(self):
		...
		"""
		for Sw in range(self.PopSize):	self.One_Decision()
		return True
...
if __name__ == '__main__':
	...
	Observer = Swallow_Observer(Params)   # Observer contains statistics
